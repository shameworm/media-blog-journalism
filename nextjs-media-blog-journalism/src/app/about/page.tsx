          ...
          <div className="container mx-auto px-4">
            <div className="grid gap-10 md:grid-cols-[1.1fr_0.9fr]">
              <div className="space-y-6">
                ...
                <div className="pt-6">
                  <h3 className="text-2xl font-semibold">
                    Партнерство: Відділ маркетингу та корпоративних комунікацій ХНЕУ ім. С. Кузнеця
                  </h3>
                  <Separator className="my-4 bg-white/20" />
                  <p className="text-base text-white/70 mb-4">
                    Проєкт реалізовано за стратегічної підтримки Відділу маркетингу
                    та корпоративних комунікацій Харківського національного економічного університету
